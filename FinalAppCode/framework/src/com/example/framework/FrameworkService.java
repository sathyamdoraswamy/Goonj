...
//	final static private String APP_NAME = "TRACE";
//    final static private String COMMAND = "COMMAND";
//    final static private String APP_KEY = "weuf9dt777nqj5d";
//	final static private String APP_SECRET = "0v624f2oy3ikisb";
...
//	    }
//
//	    // Fall back on the old API.startForegrstartForeground( R.string.service_running, notification );startForeground( R.string.service_running, notification );startForeground( R.string.service_running, notification );startForeground( R.string.service_running, notification );ound( R.string.service_running, notification );
...
//				break;				
			...
			try {
				...
				while(x<60)
				{
					System.out.println("THREAD IS SLEEPING NOW!!! "+System.currentTimeMillis()+ " "+x);
					sleep(5000);
					x++;
				}
